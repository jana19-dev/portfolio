...
<Parallax sections=4 style="background-color: #141821;" {disabled} bind:this={parallax}>
  ...
  <ParallaxLayer rate=-1>
    ...
    <Icon name="figma" top=70% left=42% animate="upDownReverse" />
    ...
    <Icon name="javascript" top=65% left=50% animate="upDown" />
    ...
    <Icon name="nginx" top=55% left=80% animate="upDownWideReverse" />
    ...
    <Icon name="redis" top=85% left=15% animate="upDownReverse" />
    <Icon name="redux" top=70% left=85% animate="upDown" />
    <Icon name="ruby" top=90% left=65% animate="upDownReverse" />
